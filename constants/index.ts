...
export const HERO_TEXTS = {
  main: 'Reviving Deteriorated Marine Environments',
  subtitle:
    ' A nature tech company dedicated to the restoration of degraded marine ecosystems',
};
